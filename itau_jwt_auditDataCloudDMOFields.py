...
async def audit_dmo_fields():
    ...
    async with aiohttp.ClientSession(headers=headers) as session:
        ...
        # **MUDANÇA CRÍTICA**: Usa a lista de DMOs da Tooling API, que é completa
        audience_dmo_names = [rec['DeveloperName'] for rec in dmo_details_records if rec['DeveloperName'].startswith(('AA_', 'AAL_'))]
